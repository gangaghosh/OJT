...
# Modifying the string by creating a new one
new_pancard_number = pancard_number[:2] + "A" + pancard_number[3:]
print("Original PAN card number:", pancard_number)
print("Modified PAN card number:", new_pancard_number)